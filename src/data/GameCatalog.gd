...
const SKILL_NODES := {
	...
	"pot_key": { "branch": "potence", "type": "keystone", "tier": 4, "clan": "brujah", "name": "Blood Rage", "desc": "Keystone [Brujah]: Frenzy becomes an opt-in BRAWL toggle. Raging: +40% melee, immune to stun/fear/knockback, but Disciplines are blocked and vitae drains. Choose when to unleash the Beast.", "conflicts": ["cel_key"] },
	...
	"obf_key": { "branch": "obfuscate", "type": "keystone", "tier": 4, "clan": "nosferatu", "name": "One With Shadow", "desc": "Keystone [Nosferatu]: A stealth feed-kill does NOT break cloak — you stay cloaked for ~2s after. Silent kills can chain. Become the dark itself.", "conflicts": ["prd_key"] },
	...
	"bs_key": { "branch": "sorcery", "type": "keystone", "tier": 4, "clan": "tremere", "name": "Vitae Alchemy", "desc": "Keystone [Tremere]: Discipline blood costs are halved — and when vitae runs short you may cast anyway, paying the shortfall as aggravated HP. Glass-cannon blood mage: power from your own flesh.", "conflicts": ["for_key"] },
